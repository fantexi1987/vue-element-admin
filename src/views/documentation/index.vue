<template>
  <div class="app-container documentation-container">
    <a class="document-btn" target='_blank' href="https://fantexi1987.github.io/vue-element-admin-site/">{{$t('documentation.documentation')}}</a>
    <a class="document-btn" target='_blank' href="https://github.com/fantexi1987/vue-element-admin/">{{$t('documentation.github')}}</a>
